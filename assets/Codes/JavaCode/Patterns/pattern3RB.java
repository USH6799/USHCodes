...
public class pattern3RB {
    ...
    public static void main(String[] args) {
        ...
        char letter = 65; // ASCII value used / Full explanation at last
        ...
        for (int i = 1; i <= n; i++) {
            ...
            //Incrementing value of letter var after completing iteration of outer loop not inner loop which means same value for letter will be for each inner loop iterations
